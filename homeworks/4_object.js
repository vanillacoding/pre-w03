  ...
  describe("객체 다루기 🔠", function () {
    describe("코드 에디터에서 homeworks/4_object.js 파일을 열어주세요.", function () {
      ...
      it("객체 데이터 다루기 #2", function () {
        ...
        person.name = "dd"; // newly added ore replaced?
        person.job = "designer";
      ...
      it("중첩된 객체 다루기 #1", function () {
        ...
        guess.contact = { //contact 라는 키값 추가해서 result랑 같게 만들기?
          email: "info@vanillacoding.co",
          phone: "02-6713-7279",
        };
      ...
      it("객체와 함수 실행문", function () {
        ...
        const guess = undefined;  //함수 sayHello() 에 return 이 안보인다? = undefined 다?
